...
const string QUERY = "pairwise";
const string TOPK = "topk";

//pairwise query
const string FORWARD = "ad-fora";
const string POWER = "power";
const string SAMBA = "samba";
const string MC = "mc";
const string MC_GROUP = "mc-group";

//top-k query
const string FAST_PRUNE = "fast-prune";
const string MC_TOPK = "mc-topk"; //mc topk with early condition
const string MC_TOPK_GROUP = "mc-topk-group";
const string FAST_PRUNE_GROUP = "fast-prune-group";

//generate files
const string GEN_SS_QUERY = "generate-ss-query";
const string GEN_GROUP ="generate-group";
const string GEN_EXACT_TOPK = "generate-exact-topk";


const string BIPPR = "bippr";
const string BIPPR_TOPK = "bippr-topk";
const string FORA = "fora";
const string FORA_TOPK ="fora-topk";
const string FWDPUSH = "fwdpush";
//const string MC = "montecarlo";
const string MC_PAIRWISE = "mc-pair";
const string BEPI = "bepi";
const string HUBPPR = "hubppr";
const string RESACC = "resacc";
const string TOPPPR = "topppr";
const string TOPPPR_V2 = "topPPR_v2"; // original topPPR
const string TOPPPR_V3 = "topPPR_v3"; // revised topPPR
const string TOPPPR_V4 = "topPPR_v4"; //(original topPPR)
const string TPA = "tpa";
const string MC_SS = "mcss";
const string MC_SQRT = "mcsqrt";
...
typedef pair<iMap<int>, iMap<double>> Mtrx_row;
...
public:
    ...
    unsigned int num_rw = 1000;

    double epsilon_prune = 0.5;
    double delta_mc_stop = 0.0;
